print('=======================================')
print("    Bem vindo a Página de Compras ")
print('=======================================')
print('Escolha qual kit você vai Querer?')
...
while opção !=4 :
    ...
    [ 2 ] CaixaChocolateImportado/FrascoPerfumeImportado
    [ 3 ] FrascoPerfume/CartelaAnalgesico/CaixaChocolateImportadoC/CaixaChocolateImportadoC
    [ 4 ] Finalizar''')
    opção = int(input('Qual é o kit '))
    if opção == 1:
        print("========================================")
        print('Saída 1')
        ...
        print('========================================')
        print('''
    Os Resultados (Saida 2) frasco
    de perfume importado e (Saida 3)
    caixa de chocolates importados 
    não batem poremo Juros aplicado
    na saída é superior ao solicitado.''')
        print('========================================')
